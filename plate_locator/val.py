...
def run(data,
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path(data.get('path', '../coco')) / 'annotations/ccpd.json')  # annotations json
        pred_json = str(save_dir / f"{w}_ccpd.json")  # predictions json
...
def parse_opt():
    ...
    opt.save_json |= opt.data.endswith('ccpd.yaml')
